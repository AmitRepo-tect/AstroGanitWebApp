...
@Component({
  selector: 'app-kundli-planet-position',
  templateUrl: './kundli-planet-position.component.html',
  styleUrl: './kundli-planet-position.component.scss'
})
export class KundliPlanetPositionComponent implements OnInit {
