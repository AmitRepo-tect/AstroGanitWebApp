...
@Component({
  selector: 'app-bhadra',
  templateUrl: './bhadra.component.html',
  styleUrl: './bhadra.component.scss'
})
export class BhadraComponent {
  ...
  addObservers() {
    ...
    this.panchangService.bhadraData$.subscribe(data => {
      if (data != null) {
  ...
  fetchBhadraData(): void {
    this.panchangService.getBhadraData(this.panchangInput?.place.Place!, this.panchangInput?.place.state!, this.panchangInput?.place.latitude!, this.panchangInput?.place.longitude!, this.panchangInput?.place.timezone!,
      this.panchangInput?.date.getDate()!, this.panchangInput?.date.getMonth()!, this.panchangInput?.date.getFullYear()!).subscribe(
        data => {
          this.panchangService.setBhadraData(data);
        },
        error => {
